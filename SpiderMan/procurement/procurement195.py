...
class Procurement1(ProcurementBaseSpider):
    name = "Procurement_195"
    base_link = ''
    hospital_name = '无锡市妇幼保健医院'
    def start_requests(self):
        # 初始页
        urls = []
        for i in range(22):
            if i==0:
                list_url = 'http://www.wxfuyou.com/WSZB/ZhongBiaoTongGao/Index.html'
            else:
                list_url = 'http://www.wxfuyou.com/WSZB/ZhongBiaoTongGao/Index_{}.html'.format(i + 1)
        ...
        self.hospital_url = 'http://www.wxfuyou.com/'
        # 遍历、翻页
