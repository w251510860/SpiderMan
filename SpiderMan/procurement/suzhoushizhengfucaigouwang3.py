...
class Suzhoushizhengfucaigouwang3(ProcurementBaseSpider):

    name = "Suzhoushizhengfucaigouwang_3"
    base_link = ''
    hospital_name = '苏州市政府采购网——保健'
    ...
    def start_requests(self):
        ...
        cookies = {
            'JSESSIONID': 'ED23163F7A58D975A7F3EDFB134C5671'
        }
