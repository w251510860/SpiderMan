...
class Procurement1(ProcurementBaseSpider):
    name = "Procurement_215"
    base_link = ''
    hospital_name = '无锡市第九人民医院'
    def start_requests(self):
        # 初始页
        urls = []
        for i in range(4):
            if i == 0:
                list_url = 'http://www.wuxi9h.com/zbxxjy/ZhongBiaoTongGaojy/Index.html'
            else:
                list_url = 'http://www.wuxi9h.com/zbxxjy/ZhongBiaoTongGaojy/Index_{}.html'.format(i + 1)
        ...
        self.hospital_url = 'http://www.wuxi9h.com/'
        # 遍历、翻页
