...
class Huaianshizhengfucaigouwang3(ProcurementBaseSpider):
    name = "Huaianshizhengfucaigouwang_3"
    base_link = ''
    hospital_name = '淮安市政府采购网_保健'

    def start_requests(self):
        # 初始页
        urls = []
        for i in range(18):
            list_url = 'http://service001.huaian.gov.cn:8080//api/query.do?q=keyword:"保健"&ename=core&pageNo={}&hl.fl=title,TEXT_CONTENT&fq=["","layer:0152*"]&rows=15&sort=release_time:desc'.format(i + 1)
